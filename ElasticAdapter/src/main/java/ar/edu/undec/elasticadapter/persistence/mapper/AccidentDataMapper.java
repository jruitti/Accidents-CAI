...
public class AccidentDataMapper {
    ...
    public static Accident dataCoreMapper(AccidentEntity anAccident){
        ...
        return Accident.factory(anAccident.getId(),anAccident.getSource(),anAccident.getTmc(),anAccident.getSeverity(),stringToLocalDateTimeParser(anAccident.getStartTime()),stringToLocalDateTimeParser(anAccident.getEndTime()),
